...
public class LenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "VAR", "INT", "STRING", "FLOAT", "VOID", "FUNC", "MAIN", "PRINT", 
			"IF", "ELSE", "WHILE", "DO", "END", "ASSIGN", "PLUS", "MINUS", "MULT", 
			"DIV", "EQ", "NEQ", "GT", "LT", "AND", "OR", "SEMI", "COLON", "COMMA", 
			"LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "ID", "CTE_INT", 
			"CTE_FLOAT", "CTE_STRING", "WS", "LETTER", "DIGIT"
		};
	}
